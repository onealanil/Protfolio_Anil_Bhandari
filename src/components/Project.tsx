...
const projects: Project[] = [
  {
    ...
    year: "2024",
    description:
      "An innovative toy programming language that brings Nepali syntax to the coding world. NepaliLang allows coding in Nepali, powered by TypeScript and inspired by Bhailang.",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "An Android app connecting skilled workers with short-term jobs in Nepal. Features include secure payment, job recommendations, and location-based listings.",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "A web app for lyricists, poets, and mental health support. Features real-time communication with SocketIO.",
    technologies: ["React.js", "Node.js", "MongoDB", "SocketIO"],
    icon: <MessageCircle className="w-6 h-6 text-green-600" />,
    embbed: (
      <iframe
        src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7072859074324787200"
        height="1100"
        width="650"
        title="Embedded post"
      ></iframe>
  ...
  },
  {
    ...
    year: "2022",
    description:
      "An automated messaging system for Facebook Messenger using AI. Developed a chatbot with ChatterBot.",
    technologies: ["Python", "Selenium", "ChatterBot", "Tkinter"],
    icon: <MessageCircle className="w-6 h-6 text-red-600" />,
    embbed: (
      <iframe
        src="https://www.linkedin.com/embed/feed/update/urn:li:ugcPost:7101211578192076800"
        height="836"
        width="650"
        title="Embedded post"
      ></iframe>
...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => (
  <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg">
    ...
    <div className="flex items-center mt-8 justify-between">
      ...
      {project.embbed && (
        <div className="flex items-center w-[10rem] md: w-full">{project.embbed}</div>
      )}
      {project.code && project.link && (
        ...
        >
          ...
          <span className="ml-2 text-gray-600 hover:text-gray-800 transition-colors">
            Code
          </span>
        </a>
      )}
...
const ProjectsShowcase = ({ setFromTab }: any) => {
  return (
